...
class GiveawayCog(commands.Cog):
    ...
    def format_giveaway_announcement(self, giveaway: Giveaway, amount: int = None) -> discord.Embed:
        ...
        embed.set_author(name=f"New Giveaway! #{giveaway.id}", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
    ...
    async def start_giveaway_timer(self, giveaway: Giveaway):
        ...
        embed = discord.Embed(colour=0xFFFFFF if Env.banano() else discord.Colour.dark_blue())
        embed.set_author(name="We have a winner!", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
    ...
    async def giveawaystats_cmd(self, ctx: Context):
        ...
        embed = discord.Embed(colour=0xFFFFFF if Env.banano() else discord.Colour.dark_blue())
        embed.set_author(name=f"Giveaway #{gw.id}", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
    ...
    async def winners_cmd(self, ctx: Context):
        ...
        embed = discord.Embed(colour=0xFFFFFF if Env.banano() else discord.Colour.dark_blue())
        embed.set_author(name=f"Here are the last {len(winners)} giveaway winners \U0001F44F", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
    ...
    async def ticketstatus_cmd(self, ctx: Context):
        ...
        if guilds == None:
            ...
            # Build response
            embed = discord.Embed(colour=0xFFFFFF if Env.banano() else discord.Colour.dark_blue())
            embed.set_author(name=f"Giveaway #{gw.id} is active!", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
        ...
        # Build response
        embed = discord.Embed(colour=0xFFFFFF if Env.banano() else discord.Colour.dark_blue())
        embed.set_author(name=f"Here are the active giveaways!", icon_url="https://cdn.discordapp.com/emojis/843275907639541770.png" if Env.banano() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png")
        embed.description = response
